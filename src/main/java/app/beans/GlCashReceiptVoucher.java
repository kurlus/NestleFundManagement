...
public class GlCashReceiptVoucher implements Serializable
{
	private static final long serialVersionUID = 2527571683213896040L;
	
	public GlCashReceiptVoucher()
	{
	...
	public Set<GlCashReceiptDet> getGlCashReceiptDet() 
	{
		return glCashReceiptDet;
	}

	public void setGlCashReceiptDet(Set<GlCashReceiptDet> glCashReceiptDet) 
	{
		this.glCashReceiptDet = glCashReceiptDet;
	} 
	...
	private Set<GlCashReceiptDet> glCashReceiptDet;
}
