...
public class GLBankPaymentVoucher implements Serializable
{
	
	private static final long serialVersionUID = -2632905267215471400L;
	
	public GLBankPaymentVoucher()
	{
	...
	public Set<GLBankPaymentDet> getGlBankPaymentDet() 
	{
		return glBankPaymentDet;
	}

	public void setGlBankPaymentDet(Set<GLBankPaymentDet> glBankPaymentDet) 
	{
		this.glBankPaymentDet = glBankPaymentDet;
	}
	...
	private Set<GLBankPaymentDet> glBankPaymentDet;
