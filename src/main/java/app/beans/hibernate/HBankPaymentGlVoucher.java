...
public class HBankPaymentGlVoucher implements Serializable {
	private static final long serialVersionUID = -2476099901435464446L;

	public HBankPaymentGlVoucher()
	{
	}
	...
	public Set<HBankPaymentDet> getGlBankPaymentDet()
	{
		return glBankPaymentDet;
	}

	public void setGlBankPaymentDet(Set<HBankPaymentDet> glBankPaymentDet)
	{
	...
	private Set<HBankPaymentDet> glBankPaymentDet;
}
