...
public class HCashPaymentGlVoucher implements Serializable
{
	private static final long serialVersionUID = 4809709603110633515L;
	
	public HCashPaymentGlVoucher()
	{
	...
	public Set<HCashPaymentDet> getCashPaymentDet() 
	{
		return cashPaymentDet;
	}
	
	public void setCashPaymentDet(Set<HCashPaymentDet> cashPaymentDet) 
	{
		this.cashPaymentDet = cashPaymentDet;
	}	
	...
	private Set<HCashPaymentDet> cashPaymentDet;
}
